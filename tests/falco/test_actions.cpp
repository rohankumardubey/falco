...
static falco::app::action::run_result success_noproceed{true, "", false};
...
// Test cases:
//  - DONE Two independent actions
//  - DONE Two actions, one depends on other
//  - DONE One independent action, two others where two depends on three
//  - DONE Two actions, one depends on other. First success=true, proceed=false, second doesn't run
//  - DONE Two actions, one depends on other. Second success=true, proceed=false, first still runs
//  - Cycle of actions, see exception
