...
void action_manager::add(std::shared_ptr<action> act)
{
	m_actions.push_back(act);
}

static bool compare_actions(const std::shared_ptr<action> &a, const std::shared_ptr<action> &b)
{
